...
namespace Sistema_Minhas_Finanças
{
    public partial class TelaPoupanca : Form
    {
        ...
        private void btnpTelaInicial_Click(object sender, EventArgs e)
        {
        ...
        private void btnpTelaLancamentos_Click(object sender, EventArgs e)
        {
        ...
        private void btnpTelanotificacoes_Click(object sender, EventArgs e)
        {
        ...
        private void carregarmovimentos()
        {
            ...
            using (var conn = new NpgsqlConnection(connString))
            {
                ...
                string selectSql = @"
                    ...
                    WHERE a.id_usuario = @idusuario AND b.tipo_conta = 'poupança'";
